...
public class CommandSteps {
	...
	public void the_existing_file_should_be_truncated() throws Throwable {
	    // Express the Regexp above with the code you wish you had
	    throw new PendingException();
	}
	...
	@Given("^the command file does not exists$")
	...
	public void an_error_message_should_be_written_to_the_console(String arg1) throws Throwable {
	    // Express the Regexp above with the code you wish you had
	    throw new PendingException();
	}
